...
export const translations = {
  he: {
    ...
    placement: {
      ...
      cv_form_title: "שלח קורות חיים",
      cv_form_sub: "מלא את הפרטים ונחזור אליך בהקדם",
      cv_name: "שם מלא *",
      cv_email: "כתובת אימייל *",
      cv_phone: "טלפון",
      cv_role: "תפקיד מבוקש",
      cv_field: "תחום עיסוק",
      cv_file: "קורות חיים (PDF / Word)",
      cv_file_hint: "גרור קובץ לכאן או לחץ לבחירה",
      cv_file_selected: "קובץ נבחר",
      cv_message: "הודעה נוספת (אופציונלי)",
      cv_submit: "שלח קורות חיים",
      cv_success: "קורות החיים נשלחו בהצלחה! נחזור אליך בהקדם.",
      cv_error: "אירעה שגיאה. אנא נסה שוב.",
      cv_field_tech: "טכנולוגיה ו-AI",
      cv_field_sales: "מכירות ושיווק",
      cv_field_hr: "משאבי אנוש",
      cv_field_finance: "כספים וחשבונאות",
      cv_field_product: "ניהול מוצר ופרויקטים",
      cv_field_cyber: "סייבר ואבטחת מידע",
      cv_field_data: "מדע נתונים ואנליטיקה",
      cv_field_other: "אחר"
    },
    contact: {
      hero_title: "צור קשר",
  ...
  en: {
    ...
    placement: {
      ...
      cv_form_title: "Submit Your CV",
      cv_form_sub: "Fill in your details and we'll get back to you shortly",
      cv_name: "Full Name *",
      cv_email: "Email Address *",
      cv_phone: "Phone",
      cv_role: "Desired Role",
      cv_field: "Field of Work",
      cv_file: "CV (PDF / Word)",
      cv_file_hint: "Drag file here or click to select",
      cv_file_selected: "File selected",
      cv_message: "Additional Message (optional)",
      cv_submit: "Submit CV",
      cv_success: "CV submitted successfully! We'll get back to you soon.",
      cv_error: "An error occurred. Please try again.",
      cv_field_tech: "Technology & AI",
      cv_field_sales: "Sales & Marketing",
      cv_field_hr: "Human Resources",
      cv_field_finance: "Finance & Accounting",
      cv_field_product: "Product & Project Management",
      cv_field_cyber: "Cyber & Information Security",
      cv_field_data: "Data Science & Analytics",
      cv_field_other: "Other"
    },
    contact: {
