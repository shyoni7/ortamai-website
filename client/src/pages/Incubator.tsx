    ...
    <div dir={dir}>
      ...
      <section className="relative py-36 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          >
            <Link href="/contact">
              <button className="inline-flex items-center gap-2 bg-cyan-500 hover:bg-cyan-400 text-white font-bold px-8 py-4 rounded-xl transition-all text-lg shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/40">
          ...
          <AnimatedSection>
            ...
            <Link href="/contact">
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className="inline-flex items-center gap-2 bg-cyan-500 hover:bg-cyan-400 text-white font-bold px-10 py-4 rounded-xl transition-colors text-lg shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/40"
              >
                {isRtl ? <ArrowLeft className="w-5 h-5" /> : null}
                {c.cta_btn}
                {!isRtl ? <ArrowLeft className="w-5 h-5 rotate-180" /> : null}
