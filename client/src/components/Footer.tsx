            ...
            <div className="space-y-2">
              {[
                ...
                <Link key={link.href} href={link.href}>
                  <span className="block text-gray-400 hover:text-orange-400 text-sm transition-colors cursor-pointer">{link.label}</span>
                </Link>
              ))}
            </div>
          </div>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-gray-500">
          ...
          <div className="flex gap-4">
            <Link href="/accessibility">
              <span className="hover:text-orange-400 transition-colors cursor-pointer">{t.footer.accessibility}</span>
            </Link>
            <Link href="/privacy">
              <span className="hover:text-orange-400 transition-colors cursor-pointer">{lang === 'he' ? 'מדיניות פרטיות' : 'Privacy Policy'}</span>
            </Link>
          </div>
        </div>
      </div>
