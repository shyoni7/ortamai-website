...
export default function WhatsAppButton() {
  ...
  return (
    // Wrap both tooltip and button in a single hover zone so moving between them
    // doesn't trigger onHoverEnd on the button.
    <div
    ...
    >
      ...
      <a
        ...
        className="relative flex items-center justify-center w-14 h-14 rounded-full shadow-lg hover:scale-110 active:scale-95 transition-transform duration-150"
